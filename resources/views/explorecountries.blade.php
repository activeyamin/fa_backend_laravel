            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="title study_title_marg">
                        <h2 class="mb-3">Study Abroad</h2>
                        <h4 class="mb-2">Guide for students who want to study abroad</h4>
                        <p>Open your mind to a new whole world – learn something new, experience world-class education
                            and develop a global
                            perspective.</p>
                    </div>
                    <b style="margin-left: -13px;">Student Essential Services</b>
                    <div class="row study_box_shadow mt-3">
                        ...
                        <div class="col-lg-6">
                            <div class="study_aboard_bg_item">
                                <a href="#">Benefits of Studying Abroad</a>
                                <p class="my-3">Earning an international degree is not only about expanding your career
                                    and personal horizons but also about having an
                                    experience of a lifetime. We share reasons why you should consider studying
                                    internationally.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row study_box_shadow">
                        ...
                        <div class="col-lg-6">
                            <div class="study_aboard_bg_item">
                                <a href="{{ route('studentbenefitcard') }}">Benefits of Studying Abroad</a>
                                <p class="my-3">Earning an international degree is not only about expanding your career
                                    and personal
                                    horizons but also about having an
                                    experience of a lifetime. We share reasons why you should consider studying
