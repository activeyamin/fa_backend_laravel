...
@section('frontend_content')
    ...
    <section id="student_benefit_banner_part2">
        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
            <ol class="breadcrumb" style="margin-left: 35px;">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="fa_helpline.html" class="text-dark">
                        FA Helpline 24 hours
                    </a>
                </li>
            </ol>
        </nav>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="student_text">
                        <h2 class="mb-3">FA Helpline</h2>
                        <h5 class="my-4">Need help? We're always here.</h5>
                        <p>We understand that some questions can’t wait so we created the IDP Helpline – a confidential, 24/7 service. The
                        Helpline’s trained advisors are ready to take your call on just about anything. They’ll help you immediately or connect
                        you with the right professionals. The IDP Helpline is here if you:</p>
                        <ul class="fa_helpline_list_style">
                            <li>Are sick and need to speak to a medical professional</li>
                            <li>Need legal advice relating to work, housing or your education provider</li>
                            <li>Want to be connected to a professional that can help you manage stress or anxiety</li>
                            <li>Have questions about your student visa status</li>
                            <li>Want assistance with lost travel documents</li>
                            <li>Need to be connected with support to help deal with a serious trauma</li>
                        </ul>
                        <h5 class="my-2">Under 18? No problem</h5>
                        <p class="my-2">If you’re under 18, the IDP Helpline team can arrange to include your parent or guardian on all calls.</p>
                        <h5 class="mt-3 mb-2">Emergency help</h5>
                        <p>For life-threatening or urgent emergencies, call Triple Zero (000) to contact the police, fire brigade or ambulance.</p>
                    </div>
                    <div class="row mt-4">
                        <div class="col-lg-6">
                            ...
                            <div class="study_next_item text-center" style="height: 320px;">
                                <a href="{{ route('findcourse') }}">
                                    <div class="study_next_item_overlay">
                                        <i class="fa-solid fa-plane-circle-check study_next_icon"></i>
                                        <p>Apply to a range of scholarships, funds and bursaries provided by the
                                            Australian...</p>
                                ...
                                <div class="study_form_item_show_js">
                                    <a href="{{ route('comeandsee') }}">
                                        <div class="study_next_item_overlay study_form_item_show_js">
                                            <i
                                                class="fa-solid fa-headphones-simple study_next_icon study_form_item_show_js"></i>
                                            <p>Want to know more contact our expert counsellors now!</p>
                                            <i
                                                class="fa-solid fa-angle-right study_next_arro_icon study_form_item_show_js"></i>
                                        </div>
                                    </a>
                                </div>
