...
<section id="computing_it_part">
    <nav class="evnt_bradcrmb_marg"
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item event_bread_col"><a href="{{ route('computingit') }}">Computing and IT Courses</a></li>
        </ol>
    </nav>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6">
                <div class="computing_item">
                    <div class="title">
                        ...
                        <h5>14091 international courses found, showing 11-20 below</h5>
                    </div>
                    ...
                    <div class="compu_drop_pos">
                        ...
                        <div class="compu_filter_btn">
                            ...
                            <div class="offcanvas offcanvas-start" style="width: 50%;" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
                                aria-labelledby="offcanvasWithBothOptionsLabel">
                                <div class="offcanvas-header">
                                    <h3 class="offcanvas-title" id="offcanvasWithBothOptionsLabel">Filter courses (1)
                                    </h3>
                                    <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                                </div>
                                <b style="margin-left: 15px;">Start a new search</b>
                                <hr></hr>
                                <!-- <h4 style="margin-left: 15px;">Subject area</h4>
                                <div class="offcanvas-body">
                                ...
                                <div class="compu_form_input_marg">
                                    <div class="offcanvas-body compu_filter_Specific_sub_area compu_sub_for_right_inp_rela">
                                        <h4>specific subject area</h4>
                                        <input type="checkbox" value=""><label for="">Computer Science</label><br>
                                        <input type="checkbox" value=""><label for="">Information Systems</label><br>
                                        <input type="checkbox" value=""><label for="">Information technology</label><br>
                                        <input type="checkbox" value=""><label for="">Computer Engineering</label><br>
                                        <input type="checkbox" value=""><label for="">Software Engineering</label><br>
                                        <div class="compu_right_input">
                                            ...
                                            <input type="checkbox" value=""><label for="">Came Development</label><br>
                                            <input type="checkbox" value=""><label for="">IT Security</label><br>
                                            <input type="checkbox" value=""><label for="">Web Development</label><br>
                                        </div>
                                    ...
                                    <div class="offcanvas-body compu_filter_Specific_sub_area compu_sub_for_right_inp_rela">
                                        ...
                                        <div class="compu_right_input comp_study_level_right_input">
                                            <input type="checkbox" value=""><label for="">Pre-Degree & Vocational</label><br>
                                            <input type="checkbox" value=""><label for="">University Preparation</label><br>
                                            <input type="checkbox" value=""><label for="">English</label><br>
                                            <input type="checkbox" value=""><label for="">School</label><br>
                                        </div>
                                        <hr>
                                    </div>
                                    <div class="offcanvas-body compu_filter_study_desitination compu_sub_for_right_inp_rela">
                                    ...
                                    <div class="offcanvas-body compu_filter_study_mode compu_sub_for_right_inp_rela">
                                        <h4>Study Mode</h4>
                                        <span class="position-absolute top-0 start-100 translate-middle p-2 bg-danger border border-light rounded-circle">
                                            <span class="visually-hidden">New alerts</span>
                                        </span>

                                        <input type="checkbox" value=""><label style="margin-right: 25px" for="">On campus study</label>
                                        <input type="checkbox" value=""><label for="">Online study</label><br>
                                        <input type="checkbox" value=""><label for="">On campus with online start (due to COVID-19)</label><br>
                                        <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-success">
                                            5000+
                                            <span class="visually-hidden">5000+</span>
                                        </span>
                                        <input style="position: relative; width: 100%;" type="range" name="range" id="">
                                        <br>
                                        <hr>
                                        <div class="offcanvas-body compu_filter_city compu_sub_for_right_inp_rela">
                                            ...
                                            <div class="comp_study_level_right_input comp_study_degina_right_input">
                                                <input type="checkbox" value=""><label for="">Los Angeles</label><br>
                                        ...
                                        <div class="offcanvas-body compu_filter_city compu_sub_for_right_inp_rela">
                                            <h4>Institution</h4>
                                            <input type="checkbox" value=""><label for="">University of Michigan - Ann Arbor</label><br>
                                            <input type="checkbox" value=""><label for="">The University of Queensland</label><br>
                                            <input type="checkbox" value=""><label for="">The Universi
                                                ty of Queensland</label><br>
                                            <input type="checkbox" value=""><label for="">University of California - Irvine</label><br>
                                            <input type="checkbox" value=""><label for="">RMIT University</label><br>
                                            <input type="checkbox" value=""><label for="">Liverpool Hope University</label><br>
                                            <div class="comp_study_inistitue_right_input">
                                                <input type="checkbox" value=""><label for="">Illinois Institute Of Technology - CEG</label><br>
                                                <input type="checkbox" value=""><label for="">Macquarie University</label><br>
                                                <input type="checkbox" value=""><label for="">Deakin University</label><br>
                                                <input type="checkbox" value=""><label for="">Northeastern University</label><br>
                                            </div>
                                            <hr>
                                            <div class="p-2">
                                                <button style="display: block; margin: auto;" class="btn btn-outline-success bg-dark text-white py-2 px-4">
                                                    Apply Filters
                                                </button>
                                            </div>
                                        </div>
            ...
            {{-- <div class="computing_item">
                <button style="margin-top: -70px !important;" type="button" class="study_shear_btn btn btn-outline-secondary mt-3">
                ...
                <div class="row mb-4">
                    <div class="col-lg-6">
                        <div class="computing_text_img_items">
                            ...
                            <div class="computing_texts">
                                <a href="#" style="text-decoration: underline; color: #414141;font-weight: 700;">At Rivier University</a><br>
                                ...
                                <div class="computing_course_status">
                                    ...
                                    <div class="com_cour_quli_item">
                                        ...
                                        <small style="cursor: pointer">Total Score</small><br>
                                        <h6>BDT 1,982,255
                                            <div class="compu_quali_mark">
                                                <p>
                                            ...
                                            <div class="col">
                                                ...
                                                <div class="card card-body">
                                                    <strong>USD 25,123</strong>
                                                    <p>Program fees are indicative only. Speak to your FA study counsellor to get up-to-date course prices.</p>
                                                </div>
                                                </div>
                                            </div>
                                            <div class="col">
                    ...
                    <div class="col-lg-6">
                        <div class="computing_text_img_items">
                            ...
                            <div class="computing_texts">
                                <a href="#" style="text-decoration: underline; color: #414141;font-weight: 700;">At Valpariso University</a><br>
                                <a href="#"><i class="fa-solid fa-location-dot"></i></a>
                                <a href="#" style="color: #414141; margin: 10px 0;">
                                    <small class="com_btm_bord">Manchester, </small>
                                ...
                                <div class="computing_course_status">
                                    ...
                                    <div class="com_cour_quli_item">
                                        ...
                                        <h6>BDT 2,134,782 <div class="compu_quali_mark">?</div></h6><br>
                                ...
                                <div class="computing_course_status">
                                    ...
                                    <div class="com_cour_quli_item">
                                        ...
                                        <div class="compu_quation_item">
                                            ...
                                            <p style="font-weight: 600;">Program fees are indicative only. Speak to your FA study counsellor to get up-to-date course prices.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="recommended_sub_item">
                    ...
                    <div class="reco_text">
                        <h5 class="mb-3">
                            <a href="#" class="text-success" style="font-weight: 600;">All about Web Development abroad</a>
                        </h5>
                        <h6 style="line-height: 24px;" class="mb-4">As technology continues to take up a bigger role in our lives, web Development presents a great pathway for
            ...
            <div class="col-lg-4">
                <div class="recommended_sub_item">
                    ...
                    <div class="reco_text">
                        <h5 class="mb-3">
                            <a href="#" class="text-success" style="font-weight: 600;">All about Software Engineering abroad
                            </a>
                        </h5>
                        <h6 style="line-height: 24px;" class="mb-4">Love creating digital magic? Studying Software Engineering could be the pathway you’re searching for, allowing you to
                        use the t...</h6>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="recommended_sub_item">
                    ...
                    <div class="reco_text">
                        <h5 class="mb-3">
                            <a href="#" class="text-success" style="font-weight: 600;">All about Computing & IT abroad</a>
                        </h5>
                        <h6 style="line-height: 24px;" class="mb-4">Computing & IT is the way of the future, with all elements of our lives now relying on computers and technology to
                            function.</h6>
                    </div>
                </div>
            </div>
