        ...
        <div class="container">
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="explore_countries.html" class="text-white">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="title study_title_marg">
                        <h2 class="mb-3">Why study abroad?</h2>
                        <p class="mb-2">See the world, experience a new culture, dive into a world-class education – and prepare for your global future. Nothing beats the immersive international experience you’ll get while studying abroad.</p>
                    </div>
                    <b style="margin-left: -13px;">You plus FA equals a world of study opportunity</b>
                    <div class="row study_box_shadow mt-3">
                        ...
                        <div class="col-lg-6">
                            <div class="study_aboard_bg_item">
                                ...
                                <p class="my-3">We’ll help you choose the course and country that’s right for you, and then guide you through the paperwork to make it happen.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row study_box_shadow">
                        ...
                        <div class="col-lg-6">
                            <div class="study_aboard_bg_item">
                                <a href="#">Benefits of overseas study</a>
                                <p class="my-3">From improved career prospects to a whole new global mindset – there are so many advantages to an international qualification!</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="study_succe_item">
                                ...
                                <div class="study_succ_text">
                                    <h5><a href="#">You’ve got the ambition. We know the way</a></h5>
                                    <p>Be ready before landing thousands of kilometres away from home.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
                            <div class="study_succe_item">
                                ...
                                <div class="study_succ_text">
                                    <h5><a href="#">You’re going places. We’ve got your back</a></h5>
                                    <p>It’s important to be ready before landing thousands of kilometres away from.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4">
