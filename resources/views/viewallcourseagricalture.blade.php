...
<!-- ========== Start Section Agriculture ========== -->
<section id="find_course_view_all_ecconomice_banner">
    <nav class="evnt_bradcrmb_marg"
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item event_bread_col"><a href="{{ route('viewallcourseecconomice') }}">Agriculture and IT Courses</a></li>
        </ol>
    </nav>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="computing_item">
                    <div class="title">
                        <h2>Agriculture courses abroad</h2>
                        <h5>2091 international courses found, showing 4-6 below</h5>
                    </div>
                </div>
            </div>
        <div class="row my-4">
                            ...
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Ontario College Graduate Certificate in Sustainable Agriculture (Co-op)</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
                                ...
                                <div class="computing_course_status">
                                    ...
                                    <div class="com_cour_quli_item">
                                        ...
                                        <h6>BDT 1,982,255 <div class="compu_quali_mark">?</div></h6><br>
                                        </button>
                        ...
                        <div class="computing_text_img_items">
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Masters/MSc in Food Safety, Hygiene and Management</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
                        ...
                        <div class="computing_text_img_items">
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Master of Biotechnology - Plant Agricultural Biotechnology</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
                        ...
                        <div class="computing_text_img_items">
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Master of Biotechnology - Agricultural Biotechnology</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
                        ...
                        <div class="computing_text_img_items">
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Master of Biotechnology - Synthetic Biology and Industrial Biotechnology</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="recommended_sub_item">
                    ...
                    <div class="reco_text">
                        <h5 class="mb-3">
                            <a href="#" class="text-success" style="font-weight: 600;">All about Agriculture& IT abroad</a>
                        </h5>
                        <h6 style="line-height: 24px;" class="mb-4">Agriculture& IT is the way of the future, with all elements of our lives now relying on computers and technology to
                            function.</h6>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="rela_rearche_item">
                    ...
                    <ul>
                        <li><a href="#">Undergraduate Agricultureand IT</a></li>
                        <li><a href="#">Postgraduate Agricultureand IT</a></li>
                        <li><a href="#">Doctorate Agricultureand IT</a></li>
                        <li><a href="#">VET Agricultureand IT</a></li>
                        <li><a href="#">Foundation Agricultureand IT</a></li>
                        <li><a href="#">Pre-Degree & Vocational Agricultureand IT</a></li>
                        <li><a href="#">University Preparation Agricultureand IT</a></li>
                        <li><a href="#">English Agricultureand IT</a></li>
                        <li><a href="#">School Agricultureand IT</a></li>
                        <li><a href="#">Agricultureand IT</a></li>
                        <li><a href="#">Computer Graphics</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="rela_rearche_item">
                    ...
                    <ul>
                        <li><a href="#">Agricultureand courses in United States Kingdom</a></li>
                        <li><a href="#">Agricultureand IT courses in United Status</a></li>
                        <li><a href="#">Agricultureand IT courses in Canada</a></li>
                        <li><a href="#">Agricultureand IT courses in New Zealand</a></li>
                        <li><a href="#">Agricultureand IT courses in Australia</a></li>
                        <li><a href="#">Agricultureand IT courses in Ireland</a></li>
                    </ul>
                </div>
            </div>
        </div>
