        ...
        <nav style="--bs-breadcrumb-divider: '';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">
                    <a href="{{ route('studyabroadfaq') }}" class="text-white">
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="text study_title_marg">
                        <h2 class="my-3">Studying Abroad FAQs</h2>
                        <p class="my-2">
                        ...
                        <strong>Am I eligible to study overseas?</strong><br>
                        <p class="my-3">To begin studying as an international student, there are a range of entry requirements you may have to meet.</p>
                        ...
                        <strong class="my-3">HHow much will it cost to study abroad?</strong>
                        <p class="mb-4">
                            To begin studying as an international student, there are a range of entry requirements you may have to meet.
                        </p>
                        <p>The academic requirements (including evidence of English language skills) you need to apply will vary depending on the level of education you want to study. For example, some courses will require you to have done a foundation course before applying for a degree. All universities and schools can have different entry requirements, so read the course information on their websites carefully.</p>
                        <p>
                            Our counsellors are here to support you with guidance on the courses and locations that best meet your preferences. Find here the cost of study based on locations: <a href="{{ route('finduscanada') }}">Canada</a>, <a href="{{ route('findusautralia') }}">Australia</a>, <a href="{{ route('findusindia') }}">India</a>, <a href="{{ route('finduscanada') }}"> Canada</a> <a href="{{ route('studynewzealand') }}">Study Newzealand</a> and Ireland.
                        </p>
