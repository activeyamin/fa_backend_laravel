...
@section('frontend_content')
    ...
    <section id="banner_part">
        <div class="banner_slider_box">
            <div class="banner_slider_item1 banner_item_padd">
                <div class="banner_slide_contents">
                    <h1 class="carouse_title">
                        Get ahead with the FA Study Abroad App
                    </h1>
                    <button class="btn mt-3">
                        <a href="{{ route('signupfree') }}">Sign up FREE<i class="fa-solid fa-angle-right"></i></a>
                    </button>
                </div>
            </div>
            <div class="banner_slider_item2 banner_item_padd">
                <div class="banner_slide_contents">
                    <h1 class="carouse_title">Planning to study in the UK?</h1>
                    <h3>Study in UK university with FA and Study Group visit FA Gulshan office | 4th June | 12:00pm to 4:00pm
                    </h3>
                </div>
            </div>
            <div class="banner_slider_item3 banner_item_padd">
                <div class="banner_slide_contents">
                    <h2 class="carouse_title"> FA Bangladesh has stepped forward to new ventures in Chattogram.</h2>
                    <h5>Walk in to our new office at: Rahima Center, 3rd Floor, 1839 CDA Avenue (Beside Sanmar, Chattogram 4000,
                        Bangladesh)</h5>
                </div>
            </div>
            <div class="banner_slider_item4 banner_item_padd">
                <div class="banner_slide_contents">
                    <h2 class="carouse_title">Can't visit our office?</h2>
                    <h4>Don't worry, we'll bring the office to you!</h4>
                    <button class="btn mt-3">
                        <a href="{{ route('signupfree') }}">Sign up FREE <i class="fa-solid fa-angle-right"></i></a>
                    </button>
                </div>
            </div>
            <div class="banner_slider_item5 banner_item_padd">
                <div class="banner_slide_contents">
                    <h2 class="carouse_title">Can't visit our office?</h2>
                    <h4>Don't worry, we'll bring the office to you!</h4>
                    <button class="btn mt-3">
            ...
            <div class="banner_slider_item6 banner_item_padd">
                <div class="banner_slide_contents">
                    <h2 class="carouse_title">
                        <h2 class="carouselTitle">
                            Pursue shorter and intensive courses in the UK
                        </h2>
                        <h3>Book your free Counseling Session</h3>
                        <button class="btn mt-3">
                            <a href="{{ route('signupfree') }}">Sign up FREE <i class="fa-solid fa-angle-right"></i></a>
                        </button>
                </div>
            </div>
            <div class="banner_slider_item7 banner_item_padd">
                <div class="banner_slide_contents">
                    <h2 class="carouselTitle">
                        Create a winning application for top Canadian universities
                    </h2>
                    <h4>Book your free Counseling Se</h4>
                    <button class="btn mt-3">
                        <a href="{{ route('signupfree') }}">Sign up FREE <i class="fa-solid fa-angle-right"></i></a>
                    </button>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="consi_item">
                        ...
                        <div class="consi_text">
                            <a href="{{ route('studentsafety') }}">Overseas Student Health Cover(OSHC)</a>
                ...
                <div class="col-sm-12 col-md-6 col-lg-4">
                    <div class="consi_item" style="position: relative;">
                        ...
                        <div class="consi_btm_btn">
                            <a href="{{ route('studenthealthcover') }}">More Student Essentials</a>
                            <i class="fa-solid fa-angle-right"></i>
                        </div>
                    </div>
                </div>
                ...
                <div class="study_form_item">
                   <form action="#" method="post" class="form-control">
                        ...
                        <div class="form_pos_resp" style="display: flex; position: relative; margin-top: 70px;">
                            ...
                            <select name="study_degination" class="form-select mb-4" style="margin-right: 20px">
            ...
            <div class="row">
                <div class="askidp_slider_box">
                    <div class="askidp_video_item">
                        <div class="img">
                            <img src="{{ asset('frontend_assets') }}/images/idp_review1.jpg" alt="idp_review1">
                        </div>
                    ...
                    <div class="askidp_video_item">
                        <div class="img">
                            <img src="{{ asset('frontend_assets') }}/images/idp_review2.jpg" alt="idp_review2.jpg">
                        </div>
                        <div class="askidp_overlay">
                            <div class="askidp_top_title">
                                <strong>Answered by</strong><br>
                    ...
                    <div class="askidp_video_item">
                        <div class="img">
                            <img src="{{ asset('frontend_assets') }}/images/idp_review3.jpg" alt="idp_review3.jpg">
                        </div>
                        <div class="askidp_overlay">
                            <div class="askidp_top_title">
                                <strong>Answered by</strong><br>
                    ...
                    <div class="askidp_video_item">
                        <div class="img">
                            <img src="{{ asset('frontend_assets') }}/images/idp_review4.jpg" alt="idp_review4.jpg">
                        </div>
                        <div class="askidp_overlay">
                            <div class="askidp_top_title">
                                <strong>Answered by</strong><br>
                    ...
                    <div class="askidp_video_item">
                        <div class="img">
                            <img src="{{ asset('frontend_assets') }}/images/idp_review5.jpg" alt="idp_review5.jpg">
                        </div>
                        <div class="askidp_overlay">
                            <div class="askidp_top_title">
                                <strong>Answered by</strong><br>
