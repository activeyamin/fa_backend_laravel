            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="text study_title_marg">
                        <h2 class="my-3">Why FA?</h2>
                        <h4 class="mb-2">Study overseas with someone who knows the way</h4>
                        <p class="mt-2">FA is the global leader in international education. We help international students study in English speaking countries. Our
                        success comes from connecting students with the right course in the right university or institution and the right
                        country.</p>
                        <p class="my-3">We've been doing it for over 50 years creating a huge network of opportunity with offices in 32 countries. Our extensive
                            network of approachable experts helps you identify and secure the university or college where you can thrive.</p>
                        <div class="bg-primary why_fa_video">
                            <a class="my-video-links" data-autoplay="true" data-vbtype="video"
                                href="https://www.facebook.com/fullstackdeveloperyamin/videos/924136365532982">
                                <i class="fa-brands fa-youtube"></i>
                            </a>
                        </div>
                        <h4 class="mt-4">Ready to start your global career? We're here to help.</h4>
                        ...
                        <h4 class="mt-4">Our counsellors are the greatest.</h4>
                        <p class="mt-2">Many FA counsellors were international students too, and are ready to do whatever it takes to help you find the right
                        course and country. They're international education experts, ready to go the extra mile and a friendly face who've 'been
                        there and done that' and willing to share what they learned.</p>

                        <h4 class="mt-4">Support every step of the way.</h4>
                        <p class="mt-2">Our support doesn't end when you receive your university acceptance letter. At FA, we're dedicated to ensuring you feel
                            supported at every stage of your study journey. We offer a full suite of services, covering English language testing
                            (IELTS), visa assistance and pre-departure advice. Our services are continually evolving to support our students through
                            to graduation and beyond.</p>

                        <h4 class="mt-4">Let’s make it happen.</h4>
                        <p class="mt-2">If you've been thinking about your overseas study options, let’s work together to find your best country, university and
                        course. Book an appointment with one of our teams, so we can start to plan your journey from where you are today, to
