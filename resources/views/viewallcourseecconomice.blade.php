...
<section id="find_course_view_all_ecconomice_banner">
    <nav class="evnt_bradcrmb_marg"
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item event_bread_col"><a href="{{ route('viewallcourseecconomice') }}">Economics and IT Courses</a></li>
        </ol>
    </nav>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="computing_item">
                    <div class="title">
                        <h2>Economics courses abroad</h2>
                        <h5>4091 international courses found, showing 11-20 below</h5>
                    </div>
                </div>
            </div>
        <div class="row my-4">
                            ...
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Bachelor of Commerce- Business Economics</h5>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="computing_text_img_items">
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Bachelor of Commerce - Economic Studies</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="recommended_sub_item">
                    ...
                    <div class="reco_text">
                        <h5 class="mb-3">
                            <a href="#" class="text-success" style="font-weight: 600;">All about Economics& IT abroad</a>
                        </h5>
                        <h6 style="line-height: 24px;" class="mb-4">Economics& IT is the way of the future, with all elements of our lives now relying on computers and technology to
                            function.</h6>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="rela_rearche_item">
                    ...
                    <ul>
                        <li><a href="#">Undergraduate Economicsand IT</a></li>
                        <li><a href="#">Postgraduate Economicsand IT</a></li>
                        <li><a href="#">Doctorate Economicsand IT</a></li>
                        <li><a href="#">VET Economicsand IT</a></li>
                        <li><a href="#">Foundation Economicsand IT</a></li>
                        <li><a href="#">Pre-Degree & Vocational Economicsand IT</a></li>
                        <li><a href="#">University Preparation Economicsand IT</a></li>
                        <li><a href="#">English Economicsand IT</a></li>
                        <li><a href="#">School Economicsand IT</a></li>
                        <li><a href="#">Economicsand IT</a></li>
                        <li><a href="#">Computer Graphics</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="rela_rearche_item">
                    ...
                    <ul>
                        <li><a href="#">Economicsand courses in United States Kingdom</a></li>
                        <li><a href="#">Economicsand IT courses in United Status</a></li>
                        <li><a href="#">Economicsand IT courses in Canada</a></li>
                        <li><a href="#">Economicsand IT courses in New Zealand</a></li>
                        <li><a href="#">Economicsand IT courses in Australia</a></li>
                        <li><a href="#">Economicsand IT courses in Ireland</a></li>
                    </ul>
                </div>
            </div>
        </div>
