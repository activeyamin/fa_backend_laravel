...
<section id="find_course_view_all_ecconomice_banner">
    <nav class="evnt_bradcrmb_marg"
        ...
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item event_bread_col"><a href="{{ route('viewallcourseecconomice') }}">Law and Legal and IT Courses</a></li>
        </ol>
    </nav>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="computing_item">
                    <div class="title">
                        <h2>Law and Legal courses abroad</h2>
                            ...
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>LLM International Commercial Law</h5>
                                    </div>
                                </a>
                            </div>
                        ...
                        <div class="computing_text_img_items">
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Master of International Business and Master of International Trade and Com...</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
                        ...
                        <div class="computing_text_img_items">
                            <div class="computing_img">
                                <a href="#">
                                    ...
                                    <div class="compu_title">
                                        <h5>Ontario Graduate Certificate in Paralegal</h5>
                                    </div>
                                </a>
                            </div>
                            <div class="computing_texts">
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="recommended_sub_item">
                    ...
                    <div class="reco_text">
                        <h5 class="mb-3">
                            <a href="#" class="text-success" style="font-weight: 600;">All about Law and Legal& IT abroad</a>
                        </h5>
                        <h6 style="line-height: 24px;" class="mb-4">Law and Legal& IT is the way of the future, with all elements of our lives now relying on computers and technology to
                            function.</h6>
                    </div>
                </div>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4">
                <div class="rela_rearche_item">
                    ...
                    <ul>
                        <li><a href="#">Undergraduate Law and Legaland IT</a></li>
                        <li><a href="#">Postgraduate Law and Legaland IT</a></li>
                        <li><a href="#">Doctorate Law and Legaland IT</a></li>
                        <li><a href="#">VET Law and Legaland IT</a></li>
                        <li><a href="#">Foundation Law and Legaland IT</a></li>
                        <li><a href="#">Pre-Degree & Vocational Law and Legaland IT</a></li>
                        <li><a href="#">University Preparation Law and Legaland IT</a></li>
                        <li><a href="#">English Law and Legaland IT</a></li>
                        <li><a href="#">School Law and Legaland IT</a></li>
                        <li><a href="#">Law and Legaland IT</a></li>
                        <li><a href="#">Computer Graphics</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-lg-4">
                <div class="rela_rearche_item">
                    ...
                    <ul>
                        <li><a href="#">Law and Legaland courses in United States Kingdom</a></li>
                        <li><a href="#">Law and Legaland IT courses in United Status</a></li>
                        <li><a href="#">Law and Legaland IT courses in Canada</a></li>
                        <li><a href="#">Law and Legaland IT courses in New Zealand</a></li>
                        <li><a href="#">Law and Legaland IT courses in Australia</a></li>
                        <li><a href="#">Law and Legaland IT courses in Ireland</a></li>
                    </ul>
                </div>
            </div>
        </div>
