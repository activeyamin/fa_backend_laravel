    ...
    <section id="computing_it_part">
        <nav class="evnt_bradcrmb_marg"
            ...
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item event_bread_col"><a href="{{ route('healthmedicine') }}">Health and Medicine Courses</a>
                </li>
            </ol>
        </nav>
        <div class="container">
            <div class="row">
                <div class="col-lg-6">
                    <div class="computing_item">
                        <div class="title">
                            <h2>Health and Medicine courses abroad</h2>
                            <h5>24282 international courses found, showing 1-10 below</h5>
                        </div>
                                    ...
                                    <div class="computing_course_status">
                                        ...
                                        <div class="com_cour_quli_item">
                                            ...
                                            <div class="compu_quation_item">
                                                ...
                                                <p style="font-weight: 600;">title="Bachelor of Exercise Science/Master of Physiotherapy and Exercise Physiology"</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="computing_text_img_items">
                                <div class="computing_img">
                                    <a href="#">
                                        ...
                                        <div class="compu_title">
                                            <h5>Ontario College Diploma in Hospitality - Hotel Operations Management</h5>
                                        </div>
                                    </a>
                                </div>
                                <div class="computing_texts">
