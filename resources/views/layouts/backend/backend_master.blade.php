...
<head>
    ...
    <link href="{{ asset('backend_assets') }}/vendor/bootstrap-select/dist/css/bootstrap-select.min.css" rel="stylesheet">
    ...
    <!-- Datatable -->
    <link href="{{ asset('backend_assets') }}/vendor/datatables/css/jquery.dataTables.min.css" rel="stylesheet">
    <!-- Custom Stylesheet -->
    {{-- sweet alert start --}}
...
<body>
    ...
    ***********************************-->
    <div id="main-wrapper">
                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                               <a class="btn btn-success text-light" href="{{ url('/') }}">visit website</a>
                           </li>
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('backend_assets') }}/images/profile/17.jpg" width="20" alt="" />
                                    <div class="header-info">
                                        <span class="text-black"><strong>{{ auth()->user()->last_name }}</strong></span>
        ...
        ***********************************-->
        <div class="deznav">
            <div class="deznav-scroll">
                <ul class="metismenu" id="menu">
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="{{ route('home') }}">Students List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                            <i class="flaticon-381-networking"></i>
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('testimonial.index') }}">Testimonial add</a></li>
                            <li><a href="{{ route('testimonial.create') }}">Testimonial List</a></li>
                        </ul>
                    </li>
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="#">Email</a></li>
                                {{-- <ul aria-expanded="false">
                                    <li><a href="{{ asset('backend_assets') }}/ecom-product-grid.html">Product Grid</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/ecom-product-list.html">Product List</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/ecom-product-detail.html">Product Details</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/ecom-product-order.html">Order</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/ecom-checkout.html">Checkout</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/ecom-invoice.html">Invoice</a></li>
                                    <li><a href="{{ asset('backend_assets') }}/ecom-customers.html">Customers</a></li>
                                </ul> --}}
                            </li>
                        </ul>
                    </li>
                ...
                <div class="copyright">
                    <p><strong>FA Student Dashboard</strong> © {{ Carbon\Carbon::now()->format('Y') }} All Rights Reserved</p>
                    <p>Made with <span class="heart"></span> by Yamin</p>
                </div>
            </div>
        </div>
        <!--**********************************
        ...
        ***********************************-->
        <div class="footer">
            <div class="copyright">
                <p>Copyright © Designed &amp; Developed by Yamin <a href="http://dexignzone.com/" target="_blank">DexignZone</a> {{ Carbon\Carbon::now()->format('Y') }}</p>
            </div>
        </div>
        <!--**********************************
            Footer end
    ...
    ***********************************-->
    ...
    <!-- Datatable -->
    <script src="{{ asset('backend_assets') }}/vendor/datatables/js/jquery.dataTables.min.js"></script>
    <script src="{{ asset('backend_assets') }}/js/plugins-init/datatables.init.js"></script>
    {{-- sweet2 alert start --}}
