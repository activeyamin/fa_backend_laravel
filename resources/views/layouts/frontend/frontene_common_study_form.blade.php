...
@section('frontend_content')
    @yield('frontend_common_banner_form')
                    <!-- =======study success start========= -->
                    ...
                    <h5 class="my-4">Further research</h5>
                    <div class="row mt-3">
                        <div class="col-lg-6">
                            <div class="study_aus_item_res text-center" style="height: 310px">
                                ...
                                <button class="btn btn-warning study_aus_btn_col mt-3">
                                    <a href="{{ route('getpersonaladvice') }}">Help me study aboard</a>
                                </button>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="study_aus_item_res text-center" style="height: 310px">
                                <h4 class="text-info">Great support!!</h4>
